...
class AccessoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create accessory" do
    assert_difference('Accessory.count') do
      post accessories_url, params: { accessory: { Name: @accessory.Name, user_id: @accessory.user_id } }
    end
  ...
  test "should update accessory" do
    patch accessory_url(@accessory), params: { accessory: { Name: @accessory.Name, user_id: @accessory.user_id } }
